...
export const AdminWiringReportPage = safeLazy(() => import("@/pages/admin/AdminWiringReportPage"), "AdminWiringReportPage");
...
export const ControlPlanePage = safeLazy(() => import("@/pages/admin/ControlPlanePage"), "ControlPlanePage");
