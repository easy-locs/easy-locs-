...
const DOMAIN_RULES: DomainRepairRule[] = [
  ...
  // ─── FOOD domain ──────────────────────────────────────────
  {
    id: "food:menu:stale",
    domain: "food",
    issuePattern: /menu[:\-_]stale|menu[:\-_]expired|menu[:\-_]outdated/i,
    category: "data",
    severity: "low",
    operation: "refresh",
    target: "el-food-menu",
    ...
    maxRetries: 3,
    cooldownMs: 60_000,
    description: "Refresh stale food menu data",
    priority: "text_integrity",
    minConfidence: 0.5,
    mutationCost: 1,
    wrapperMutation: false,
  ...
  {
    id: "food:taxonomy:mismatch",
    domain: "food",
    issuePattern: /taxonomy[:\-_]mismatch|vertical[:\-_]wrong|category[:\-_]wrong/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-food-taxonomy",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 300_000,
    description: "Fix food taxonomy vertical mismatch",
    priority: "severe_visibility",
    minConfidence: 0.7,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  // ─── GROCERY domain ───────────────────────────────────────
  {
    id: "grocery:catalog:stale",
    domain: "grocery",
    issuePattern: /catalog[:\-_]stale|product[:\-_]expired|stock[:\-_]outdated/i,
    category: "data",
    severity: "low",
    operation: "refresh",
    target: "el-grocery-catalog",
    repairLevel: "L2",
    maxRetries: 3,
    cooldownMs: 60_000,
    description: "Refresh stale grocery catalog",
    priority: "text_integrity",
    minConfidence: 0.5,
    mutationCost: 1,
    wrapperMutation: false,
  ...
  {
    id: "grocery:taxonomy:mismatch",
    domain: "grocery",
    issuePattern: /taxonomy[:\-_]mismatch|vertical[:\-_]wrong|category[:\-_]wrong/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-grocery-taxonomy",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 300_000,
    description: "Fix grocery taxonomy vertical mismatch",
    priority: "severe_visibility",
    minConfidence: 0.7,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  // ─── SERVICES domain ──────────────────────────────────────
  {
    id: "services:booking:stale",
    domain: "services",
    issuePattern: /booking[:\-_]stale|slot[:\-_]expired|availability[:\-_]outdated/i,
    category: "data",
    severity: "medium",
    operation: "refresh",
    target: "el-services-booking",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 120_000,
    description: "Refresh stale service booking slots",
    priority: "severe_visibility",
    minConfidence: 0.6,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  {
    id: "services:taxonomy:mismatch",
    domain: "services",
    issuePattern: /taxonomy[:\-_]mismatch|vertical[:\-_]wrong|category[:\-_]wrong/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-services-taxonomy",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 300_000,
    description: "Fix services taxonomy vertical mismatch",
    priority: "severe_visibility",
    minConfidence: 0.7,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  // ─── PROPERTY domain ──────────────────────────────────────
  {
    id: "property:listing:stale",
    domain: "property",
    issuePattern: /listing[:\-_]stale|listing[:\-_]expired|property[:\-_]outdated/i,
    category: "data",
    severity: "low",
    operation: "refresh",
    target: "el-property-listings",
    repairLevel: "L2",
    maxRetries: 3,
    cooldownMs: 120_000,
    description: "Refresh stale property listings",
    priority: "text_integrity",
    minConfidence: 0.5,
    mutationCost: 1,
    wrapperMutation: false,
  ...
  {
    id: "property:taxonomy:mismatch",
    domain: "property",
    issuePattern: /taxonomy[:\-_]mismatch|vertical[:\-_]wrong|category[:\-_]wrong/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-property-taxonomy",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 300_000,
    description: "Fix property taxonomy vertical mismatch",
    priority: "severe_visibility",
    minConfidence: 0.7,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  // ─── SEO domain ───────────────────────────────────────────
  {
    id: "seo:canonical:duplicate",
    domain: "seo",
    issuePattern: /canonical[:\-_]dup|duplicate[:\-_]url|canonical[:\-_]missing/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-seo-canonical",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 600_000,
    description: "Invalidate pages with duplicate or missing canonical URLs",
    priority: "severe_visibility",
    minConfidence: 0.7,
    mutationCost: 2,
    wrapperMutation: false,
  ...
  },
  {
    ...
    domain: "seo",
    issuePattern: /jsonld[:\-_]missing|structured[:\-_]data[:\-_]missing|schema[:\-_]missing/i,
    category: "data",
    severity: "low",
    operation: "refresh",
    target: "el-seo-jsonld",
    repairLevel: "L2",
    maxRetries: 2,
    cooldownMs: 300_000,
    description: "Refresh pages with missing JSON-LD structured data",
    priority: "text_integrity",
    minConfidence: 0.6,
    mutationCost: 1,
    wrapperMutation: false,
  ...
  {
    id: "seo:sitemap:dead_url",
    domain: "seo",
    issuePattern: /sitemap[:\-_]dead|dead[:\-_]url|404[:\-_]in[:\-_]sitemap/i,
    category: "data",
    severity: "medium",
    operation: "invalidate",
    target: "el-seo-sitemap",
    repairLevel: "L2",
    maxRetries: 1,
    cooldownMs: 600_000,
    description: "Remove dead URLs from sitemap",
    priority: "severe_visibility",
    minConfidence: 0.8,
    mutationCost: 2,
    wrapperMutation: false,
