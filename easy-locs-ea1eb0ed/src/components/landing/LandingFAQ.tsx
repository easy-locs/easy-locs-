...
const faqs = [
  ...
  },
  {
    ...
    qFallback: "Is Easy-Locs free to start? How does the commission work?",
    aFallback: "Yes, Easy-Locs is free for clients — zero fees, zero commissions on orders, rides, bookings. Merchants and partners pay only 5% platform commission (vs. 30% on Uber, Deliveroo, Booking). Plans start at free with unlimited listings, then from €9.99/month for advanced features. You keep 95% of your revenue.",
  },
  {
    qKey: "landing.faq.q5", aKey: "landing.faq.a5",
    qFallback: "How do payments work on the platform?",
    aFallback: "Easy-Locs has a built-in wallet with QR code payments (scan to pay, like WeChat Pay or GrabPay), plus credit cards (Visa, Mastercard, Apple Pay, Google Pay), SEPA direct debit, and bank transfers. Wallet-to-wallet transfers are instant and free. All payments go directly to your account — we never hold your money.",
  },
  {
