...
const FOOD_SUBCATS = [
  { label: "Pizza", emoji: "🍕", to: "/browse/food?sub=pizza" },
  { label: "Sushi", emoji: "🍣", to: "/browse/food?sub=sushi" },
  { label: "Burger", emoji: "🍔", to: "/browse/food?sub=burger" },
  { label: "Shawarma", emoji: "🌯", to: "/browse/food?sub=shawarma" },
  { label: "Coffee", emoji: "☕", to: "/browse/food?sub=coffee" },
  { label: "Bakery", emoji: "🥐", to: "/browse/food?sub=bakery" },
  { label: "Desserts", emoji: "🍰", to: "/browse/food?sub=desserts" },
  { label: "Healthy", emoji: "🥗", to: "/browse/food?sub=healthy" },
];
