 ...
 * Each card links to a specific destination search.
 */
...
const TRAVEL_CARDS = [
  { title: "Dubai Marina Apartment", location: "Dubai, UAE", price: "$89/night", rating: 4.8, image: travelBanner, type: "Hotel", slug: "dubai" },
  { title: "Bali Villa Resort", location: "Bali, Indonesia", price: "$120/night", rating: 4.9, type: "Resort", slug: "bali" },
  { title: "Paris Studio Central", location: "Paris, France", price: "$75/night", rating: 4.6, type: "Apartment", slug: "paris" },
  { title: "Tokyo Business Suite", location: "Tokyo, Japan", price: "$95/night", rating: 4.7, type: "Suite", slug: "tokyo" },
  { title: "Dakar Ocean View", location: "Dakar, Senegal", price: "$55/night", rating: 4.5, type: "Villa", slug: "dakar" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">
              {t("landing.travel.subtitle") || "Book direct from owners \u00B7 0% fees \u00B7 5% platform only \u00B7 Worldwide"}
            </p>
          </div>
          <Link
            to="/travel"
        ...
        <div className="flex gap-3 overflow-x-auto pb-3 scrollbar-none snap-x snap-mandatory">
          {TRAVEL_CARDS.map((card, i) => (
            ...
            >
              <Link
                to={`/travel?destination=${card.slug}&type=${card.type.toLowerCase()}`}
