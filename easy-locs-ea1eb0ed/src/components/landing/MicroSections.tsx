...
const TOP_CUISINES = [
  { labelKey: "landing.micro.pizza", emoji: "🍕", to: "/browse/food?sub=pizza", countKey: "landing.micro.pizza_count" },
  { labelKey: "landing.micro.sushi", emoji: "🍣", to: "/browse/food?sub=sushi", countKey: "landing.micro.sushi_count" },
  { labelKey: "landing.micro.burger", emoji: "🍔", to: "/browse/food?sub=burger", countKey: "landing.micro.burger_count" },
  { labelKey: "landing.micro.shawarma", emoji: "🌯", to: "/browse/food?sub=shawarma", countKey: "landing.micro.shawarma_count" },
  { labelKey: "landing.micro.coffee", emoji: "☕", to: "/browse/food?sub=coffee", countKey: "landing.micro.coffee_count" },
  { labelKey: "landing.micro.bakery", emoji: "🥐", to: "/browse/food?sub=bakery", countKey: "landing.micro.bakery_count" },
];
