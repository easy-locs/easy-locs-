    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          exit={{ y: -60, opacity: 0 }}
          className="fixed top-2 left-1/2 z-fullscreen flex max-w-sm -translate-x-1/2 items-center gap-3 rounded-xl border border-border bg-card px-4 py-2.5 shadow-lg"
        >
