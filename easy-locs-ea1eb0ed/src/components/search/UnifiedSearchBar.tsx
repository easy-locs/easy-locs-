    ...
    return (
      <>
        <button
          ...
          className={cn(
            "flex h-10 w-full min-w-0 items-center gap-2.5 rounded-xl border border-border/20 bg-card px-3 text-sm text-muted-foreground shadow-sm active:scale-[0.98] transition-transform",
            className
          )}
        >
