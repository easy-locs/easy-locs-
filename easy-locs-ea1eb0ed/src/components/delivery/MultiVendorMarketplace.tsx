        ...
        <div className="space-y-2">
          ...
          {filtered.map(p => (
            <div key={p.id} className="rounded-xl p-3 flex items-center gap-3"
              ...
              <Button size="sm" className="text-[10px] h-7 px-2" onClick={() => addToCart(p)}
            ...
            <>
              {sellerGroups.map(seller => (
                <div key={seller} className="space-y-1.5">
                  <p className="text-[10px] font-bold flex items-center gap-1" style={{ color: "hsl(var(--primary))" }}>
                  ...
                  {cart.filter(c => c.seller === seller).map(c => (
                    <div key={c.id} className="rounded-lg p-2 flex items-center gap-2"
                      ...
                      <span>{c.image}</span>
                      <div className="flex-1 min-w-0">
                        <p className="text-[10px] font-medium truncate" style={{ color: "hsl(var(--foreground))" }}>{c.name}</p>
                        <p className="text-[10px]" style={{ color: "hsl(var(--muted-foreground))" }}>{c.price.toLocaleString()} F</p>
                      </div>
                      ...
                      <span className="text-[10px] font-bold w-14 text-right" style={{ color: "hsl(var(--foreground))" }}>
            ...
            return (
              <div key={sid} className="rounded-xl p-3"
                ...
                <div className="flex items-center gap-1 mt-1">
                  <span className="text-[10px] font-semibold" style={{ color: "hsl(var(--success))" }}>🚚 ~25 min</span>
                  <span className="text-[10px]" style={{ color: "hsl(var(--muted-foreground))" }}>•</span>
                  <span className="text-[10px] font-semibold" style={{ color: "hsl(var(--warning))" }}>500 F livraison</span>
                </div>
              </div>
            );
          })}
