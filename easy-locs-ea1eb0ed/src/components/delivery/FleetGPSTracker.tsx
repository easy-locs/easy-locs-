          ...
          {drivers.map(d => (
            <motion.div key={d.id}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-[10px] px-1.5 py-0.5 rounded-full" style={{ background: statusColor(d.status) + "15", color: statusColor(d.status) }}>
                    {d.status === "online" ? "Disponible" : d.status === "busy" ? "En mission" : "Hors ligne"}
                  </span>
                  <span className="text-[10px]" style={{ color: "hsl(var(--muted-foreground))" }}>{d.vehicleType}</span>
                </div>
              </div>
              <div className="text-right">
                ...
                <p className="text-[10px]" style={{ color: d.batteryLevel < 20 ? "hsl(var(--destructive))" : "hsl(var(--muted-foreground))" }}>
          ...
          {[
            ...
            <div key={i} className="rounded-xl p-3 flex items-center gap-3"
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px]" style={{ color: "hsl(var(--muted-foreground))" }}>{t.date}</p>
              </div>
              <div className="text-right">
                <p className="text-[10px] font-bold" style={{ color: "hsl(var(--primary))" }}>{t.dist} km</p>
                <p className="text-[10px]" style={{ color: "hsl(var(--muted-foreground))" }}>{t.time}</p>
              </div>
            </div>
          ))}
        </div>
