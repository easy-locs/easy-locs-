                ...
                <div key={t.id} className="rounded-xl p-3 space-y-1.5" style={{ background: "hsl(var(--hud-surface))", border: `1px solid ${st.color}15` }}>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[10px]" style={{ color: "hsl(var(--hud-text-dim) / 0.4)" }}>{t.vehiclePlate} • {t.vehicleModel}</p>
                    </div>
              ...
              return (
                <div key={t.id} className="rounded-lg px-3 py-2 flex items-center gap-2"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px]" style={{ color: "hsl(var(--hud-text-dim) / 0.4)" }}>{t.vehiclePlate} • {t.completedDate}</p>
                  </div>
              ...
              return (
                <div key={t.id} className="rounded-xl p-3 flex items-center gap-3"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px]" style={{ color: "hsl(var(--hud-text-dim) / 0.4)" }}>{t.vehiclePlate} • {t.scheduledDate}</p>
                  </div>
