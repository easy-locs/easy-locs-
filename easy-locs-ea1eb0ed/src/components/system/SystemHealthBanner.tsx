...
export function SystemHealthBanner({ db, auth, realtime, checked }: Props) {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-fullscreen bg-destructive/90 px-3 py-1.5 text-center text-[0.6875rem] leading-relaxed text-destructive-foreground backdrop-blur-sm">
