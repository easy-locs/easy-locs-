      ...
      {photos.length > 0 ? (
        <div className="relative aspect-[16/10] shrink-0 bg-muted overflow-hidden">
          ...
          <div className="absolute top-2.5 left-2.5 flex items-center gap-1.5">
            ...
            {verified && (
            <span className="flex items-center gap-0.5 bg-accent/90 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full backdrop-blur-sm shadow-sm">
        ...
        <div className="h-36 sm:h-48 shrink-0 bg-gradient-to-br from-accent/5 to-muted/50 flex flex-col items-center justify-center gap-2 relative">
          ...
          {verified && (
            <span className="absolute top-2.5 left-2.5 flex items-center gap-0.5 bg-accent/90 text-white text-[10px] font-semibold px-1.5 py-0.5 rounded-full">
              <CheckCircle2 className="h-3 w-3" /> {t("mp.verified") || "Verified"}
            </span>
          )}
        </div>
