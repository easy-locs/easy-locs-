        ...
        {!selectedVertical ? (
          ...
          >
            <div className="px-3 py-2">
              <span className="text-xs font-bold uppercase tracking-wider" style={{ color: "hsl(220 40% 18% / 0.5)" }}>
            ...
            {subMenu.map(cluster => (
              <div key={cluster.id} className="mb-3">
                <div className="px-3 py-1.5">
                  <span className="text-[11px] font-bold uppercase tracking-wider" style={{ color: "hsl(220 40% 18% / 0.4)" }}>
