            ...
            >
              ...
              {active && !isOrbit && (
                <motion.div
                  ...
                  style={{
                    background: "radial-gradient(ellipse at top, hsl(var(--primary) / 0.08) 0%, transparent 70%)",
                  }}
              ...
              {isOrbit ? (
                ...
                >
                  ...
                  {orbitUnread > 0 && (
                    <motion.span
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] rounded-full flex items-center justify-center text-[10px] font-black leading-none px-1"
                      style={{
                ...
                >
                  <Icon
                    ...
                    strokeWidth={active ? 2.4 : 1.8}
                    style={{
                      color: active ? "hsl(var(--primary))" : "hsl(var(--muted-foreground) / 0.45)",
                    }}
                  />
                </motion.div>
              )}
