...
function getActionLabel(type: ThreadActionType, t: (k: string) => string | undefined): string {
  const labels: Record<ThreadActionType, string> = {
    pay: t("orbit.pay"),
    confirm: t("orbit.confirm"),
    cancel: t("orbit.cancel"),
    sign: t("orbit.sign"),
    track: t("orbit.track"),
    view_receipt: t("orbit.receipt"),
    view_document: t("orbit.document"),
    rate: t("orbit.rate"),
    dispute: t("orbit.dispute"),
    refund: t("orbit.refund"),
    schedule: t("orbit.schedule"),
    share_location: t("orbit.share_location"),
    call: t("orbit.call"),
    video_call: t("orbit.video_call"),
  };
