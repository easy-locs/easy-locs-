...
export function AdminRoutes() {
  return (
    <>
      ...
      {/* Task #988 — Removed accidentally-duplicated /admin/control/* block
          (and second copy of legacy redirects) that previously lived here.
          They were unreachable due to React Router v6 first-match semantics
          and used a different shell component (AdminControlShellPage). The
          canonical shell is AdminShellWithChunkBoundary above. The legacy
          AdminControlShellPage component remains exported in
          app-route-registry for direct callers and tests. */}
