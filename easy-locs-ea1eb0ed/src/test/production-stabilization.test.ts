...
describe("Portal Detection", () => {
  it("detects tenant portal from URL", async () => {
    ...
    const notif = { metadata_json: { target_url: "/wallet?record=p-1" } };
