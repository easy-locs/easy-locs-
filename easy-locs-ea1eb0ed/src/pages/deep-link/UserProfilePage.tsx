...
import { customerService, storefrontService } from "@/services";
...
export default function UserProfilePage() {
  ...
  const { data: profile, isLoading } = useQuery({
    ...
    queryFn: async () => {
      return customerService.fetchPublicProfile(userId!);
    },
    enabled: !!userId,
  });
  ...
  const { data: shop } = useQuery({
    ...
    queryFn: async () => {
      return storefrontService.fetchPageBySlugOrId(userId!, "id, slug, name");
    },
    enabled: !!userId,
  });
