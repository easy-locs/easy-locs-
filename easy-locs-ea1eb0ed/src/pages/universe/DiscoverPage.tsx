...
export default function DiscoverPage() {
  ...
  return (
    <SubPageShell>
      ...
      <div className="sticky top-0 z-30 px-4 pt-3 pb-2 bg-background border-b border-border/10">
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 rounded-xl text-sm border-none outline-none bg-muted"
