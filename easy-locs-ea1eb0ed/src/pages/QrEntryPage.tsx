...
export default function QrEntryPage() {
  ...
  if (error) {
    return (
      <SubPageShell title="QR Entry" onBack={() => navigate(-1)} noContentPad className="flex flex-col items-center justify-center px-6 py-12">
  ...
  return (
    <SubPageShell noContentPad className="flex flex-col items-center justify-center">
