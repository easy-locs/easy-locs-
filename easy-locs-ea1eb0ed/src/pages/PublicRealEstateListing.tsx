                    ...
                    <div className="flex gap-3 pt-1">
                      ...
                      {listing.agency_email && (
                        <button onClick={async () => {
                          ...
                          const path = await navigateToOrbitThread({ targetEmail: listing.agency_email, targetName: listing.agency_name || "Agency" });
                          if (path) navigate(path);
                        }} className="text-xs text-accent hover:underline">💬 Message</button>
                      )}
                    </div>
                  </div>
                </div>
