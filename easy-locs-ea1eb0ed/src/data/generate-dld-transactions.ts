...
const DISTRICT_BUILDINGS: Record<string, string[]> = {
  ...
  "Tilal Al Ghaf": [
    ...
    "TAG Residences Phase 1", "TAG Residences Phase 2",
    "Elysian Mansions 1", "Elysian Mansions 2",
    "The Sustainable City TAG Phase 1", "The Sustainable City TAG Phase 2",
    "Tilal Al Ghaf Villas Phase 1", "Tilal Al Ghaf Villas Phase 2",
    "Alana by Emaar TAG", "Gardens by Emaar TAG",
    "Parkside Living TAG 1", "Parkside Living TAG 2",
  ],
  "Dubai South": [
