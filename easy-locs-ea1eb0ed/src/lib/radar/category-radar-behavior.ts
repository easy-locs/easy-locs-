...
export const CATEGORY_RADAR_BEHAVIORS: Record<string, RadarCategoryBehavior> = {
  ...
  stay: {
    vertical: "stay",
    showDistanceSlider: true,
    sortFields: ["price", "rating", "distance", "stars"],
    useDeliveryZones: false,
    usePrepTime: false,
    useRiderETA: false,
    showLiveRiders: false,
    ...
    useStockAvailability: true,
    defaultRadiusKm: 30,
    filterLabels: { primary: "Dates", secondary: "Price per night" },
  },
  health: {
    vertical: "health",
    showDistanceSlider: true,
    sortFields: ["distance", "availability", "rating"],
    useDeliveryZones: false,
    usePrepTime: false,
    useRiderETA: false,
    showLiveRiders: false,
    ...
    useStockAvailability: false,
    defaultRadiusKm: 15,
    filterLabels: { primary: "Specialty", secondary: "Available now" },
  },
  education: {
    vertical: "education",
    showDistanceSlider: true,
    sortFields: ["rating", "price", "distance"],
    useDeliveryZones: false,
    usePrepTime: false,
    useRiderETA: false,
    showLiveRiders: false,
    ...
    useStockAvailability: false,
    defaultRadiusKm: 20,
    filterLabels: { primary: "Subject", secondary: "Level" },
  },
  finance: {
    vertical: "finance",
    showDistanceSlider: true,
    sortFields: ["distance", "rating"],
    useDeliveryZones: false,
    usePrepTime: false,
    useRiderETA: false,
    showLiveRiders: false,
    ...
    useStockAvailability: false,
    defaultRadiusKm: 10,
    filterLabels: { primary: "Service type" },
  },
  utility: {
    vertical: "utility",
    showDistanceSlider: false,
