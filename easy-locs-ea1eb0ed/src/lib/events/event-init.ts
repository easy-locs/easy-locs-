...
const BRIDGE_MAP: Record<string, string[]> = {
  ...
  // NOTE: colon-notation aliases removed — NOTATION_BRIDGE in platform-bus.ts
  // already converts dot↔colon, so only ONE notation is needed here.
