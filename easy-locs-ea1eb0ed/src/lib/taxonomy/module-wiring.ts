...
export type VerticalKey =
  ...
  | "nightlife" | "experiences" | "mobility" | "healthcare";
...
export const MODULE_WIRING: Record<VerticalKey, ModuleWiring> = {
  ...
  nightlife: {
    ...
    emoji: "🌙",
    dashboard: {
      shortcuts: ["bar", "club", "lounge", "rooftop", "live_music"],
      recentItemType: "venue",
      activeItemType: null,
      quickActions: [
        { icon: "🌙", label: "Nightlife", route: "/browse/nightlife" },
      ],
      showPromotions: true,
      showRecommendations: true,
      showActiveOrders: false,
    ...
    radar: {
      discoveryMode: "proximity",
      entityType: "venue",
      primaryFilters: ["type", "price", "rating", "distance", "open_now"],
      mapPinType: "merchant",
      showAvailability: true,
      showPricing: true,
      showRating: true,
      ...
      showETA: false,
      defaultSortBy: "rating",
      radarCategory: "nightlife",
    },
    orbit: {
      threadTypes: ["venue_inquiry", "table_reservation", "event_question"],
      contactLabel: "Contact venue",
      entityLink: "booking",
      supportsGroupThread: false,
      supportsAttachments: true,
      supportsLocation: true,
    ...
    me: {
      historyType: "visits",
      favoritesType: "venues",
      preferencesKeys: ["music_preferences", "venue_types"],
      documentsType: null,
      addressRelevance: "none",
      showInProfile: false,
    },
  ...
  experiences: {
    ...
    emoji: "✨",
    dashboard: {
      shortcuts: ["tour", "adventure", "class", "workshop", "escape_room"],
      recentItemType: "experience",
      activeItemType: "booking",
      quickActions: [
        { icon: "✨", label: "Experiences", route: "/browse/experiences" },
      ],
      showPromotions: true,
      showRecommendations: true,
      showActiveOrders: false,
    ...
    radar: {
      ...
      primaryFilters: ["type", "date", "price", "rating", "distance", "duration"],
      mapPinType: "event",
      showAvailability: true,
      showPricing: true,
      showRating: true,
      ...
      showETA: false,
      defaultSortBy: "rating",
      radarCategory: "experiences",
    },
    orbit: {
      threadTypes: ["booking_support", "organizer_contact", "experience_question"],
      contactLabel: "Contact organizer",
      entityLink: "booking",
      supportsGroupThread: true,
      supportsAttachments: true,
    ...
    me: {
      historyType: "bookings",
      favoritesType: "experiences",
      preferencesKeys: ["activity_interests", "group_size"],
      documentsType: "tickets",
      addressRelevance: "visit",
      showInProfile: true,
    },
  ...
  mobility: {
    ...
    emoji: "🚗",
    dashboard: {
      shortcuts: ["scooter", "bike", "bus", "metro", "car_share"],
      recentItemType: "vehicle",
      activeItemType: "ride",
      quickActions: [
        { icon: "🚗", label: "Mobility", route: "/mobility" },
      ],
      showPromotions: false,
      showRecommendations: false,
      showActiveOrders: true,
    ...
    radar: {
      ...
      showETA: true,
      defaultSortBy: "eta",
      radarCategory: "mobility",
    },
    orbit: {
      threadTypes: ["ride_support", "driver_contact"],
      contactLabel: "Contact driver",
      entityLink: "job",
      supportsGroupThread: false,
      supportsAttachments: false,
    ...
    me: {
      historyType: "rides",
      favoritesType: "destinations",
      preferencesKeys: ["home_address", "work_address", "vehicle_preference"],
      documentsType: null,
      addressRelevance: "delivery",
      showInProfile: false,
    },
  ...
  healthcare: {
    ...
    emoji: "❤️",
    dashboard: {
      shortcuts: ["pharmacy", "clinic", "hospital", "dentist", "lab"],
      recentItemType: "provider",
      activeItemType: "booking",
      quickActions: [
        { icon: "❤️", label: "Healthcare", route: "/browse/healthcare" },
      ],
      showPromotions: false,
      showRecommendations: true,
      showActiveOrders: false,
    ...
    radar: {
      discoveryMode: "proximity",
      entityType: "health_provider",
      primaryFilters: ["specialty", "availability", "distance", "rating"],
      mapPinType: "merchant",
      showAvailability: true,
      showPricing: true,
      showRating: true,
