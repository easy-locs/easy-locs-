 ...
 * ==================================================
 * 12 primary categories → subcategories → architecture type → fulfillment → mobility
 *
...
export const CATEGORY_TREE: PrimaryCategory[] = [
  // ─── 1. FOOD ──────────────────────────────────────────────
  {
    ...
    subcategories: [
      ...
      { value: "pakistani", label: "Pakistani", emoji: "🍛", cluster: "cuisine", tags: ["south asian", "biryani", "karahi"] },
    ],
  },
  ...
  // ─── 11. UTILITY (ATM, Fuel, Parking — Nearby Essential Places) ──
  {
    ...
    subcategories: [
      ...
      { value: "hospital", label: "Hospital", emoji: "🏥", cluster: "emergency", tags: ["emergency", "medical", "clinic", "health", "urgences"] },
      ...
      { value: "pharmacy", label: "Pharmacy", emoji: "💊", cluster: "health", tags: ["pharmacy", "medicine", "drugs", "health", "pharmacie"] },
      { value: "veterinary", label: "Veterinary", emoji: "🐾", cluster: "health", tags: ["vet", "veterinary", "animal", "pet", "clinic"] },
      ...
      { value: "supermarket", label: "Supermarket", emoji: "🛒", cluster: "shopping", tags: ["supermarket", "grocery", "market"] },
