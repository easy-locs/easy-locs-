...
import type { BrowserRepairScenario } from "./types";
...
export const CANONICAL_SCENARIOS: ScenarioDefinition[] = [
  ...
  { key: "orbit_realtime_check", pageKey: "/orbit", flowKey: "realtime", description: "Realtime flow", severityIfFail: "critical", canAutoFix: false, scope: "orbit", steps: [{ key: "recent_messages", description: "Recent messages" }] },
  ...
  { key: "orbit_add_group_member", pageKey: "/orbit", flowKey: "groups", description: "Group members manageable", severityIfFail: "warning", canAutoFix: true, scope: "orbit", steps: [{ key: "participants_valid", description: "Participants structure valid" }] },
  ...
  // ── DASHBOARD ──
  { key: "dashboard_route_check", pageKey: "/dashboard", flowKey: "routing", description: "Dashboard route accessible", severityIfFail: "critical", canAutoFix: false, scope: "global", steps: [{ key: "orgs_accessible", description: "Orgs accessible" }] },
  ...
  // ── BOOKING ──
  { key: "booking_data_check", pageKey: "/travel", flowKey: "booking", description: "Booking tables accessible", severityIfFail: "warning", canAutoFix: false, scope: "hotel", steps: [{ key: "bookings_table", description: "Bookings accessible" }] },
  ...
  { key: "stale_loading_check", pageKey: "/dashboard", flowKey: "ux_quality", description: "Stuck loading / stuck engines", severityIfFail: "warning", canAutoFix: true, scope: "global", steps: [{ key: "stuck_engines", description: "Stuck engines check" }] },
];

export const BROWSER_REPAIR_SCENARIOS: BrowserRepairScenario[] = CANONICAL_SCENARIOS.map(s => ({
  key: s.key,
  pageKey: s.pageKey,
  flowKey: s.flowKey,
  area: s.scope,
  ...
  severityIfFail: s.severityIfFail as any,
