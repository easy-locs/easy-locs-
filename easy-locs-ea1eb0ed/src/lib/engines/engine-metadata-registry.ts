...
export const ENGINE_METADATA: Record<string, EngineMetadata> = {
  ...
  "module-link":           { tier: "standard",    businessFn: "infrastructure", vertical: "all", canRunIdle: true,  tablesWritten: [],                   fieldsWritten: [],                              description: "Validates end-to-end wiring between taxonomy and 5 pillars", brainOwner: "experience" },
