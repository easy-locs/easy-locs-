...
const REQUIRED_FIELDS: Record<string, string[]> = {
  ...
  stay: ["canonicalName", "address", "lat", "lng", "photos"],
  services: ["canonicalName", "address", "lat", "lng", "phone"],
  property: ["canonicalName", "address", "lat", "lng", "photos"],
  shops: ["canonicalName", "address", "lat", "lng"],
  mobility: ["canonicalName"],
  utility: ["canonicalName", "lat", "lng"],
  healthcare: ["canonicalName", "address", "lat", "lng", "phone"],
  experiences: ["canonicalName", "address", "lat", "lng"],
};
...
const RECOMMENDED_FIELDS: Record<string, string[]> = {
  ...
  stay: ["phone", "description", "rating", "logoUrl", "hotelInventory"],
  services: ["logoUrl", "openingHours", "photos", "description", "serviceItems"],
  property: ["description", "photos", "phone"],
  shops: ["logoUrl", "photos", "description", "openingHours"],
  mobility: ["description", "phone", "photos"],
  utility: ["address", "phone", "openingHours", "photos"],
  healthcare: ["description", "openingHours", "photos", "rating"],
  experiences: ["description", "photos", "phone", "rating"],
};
