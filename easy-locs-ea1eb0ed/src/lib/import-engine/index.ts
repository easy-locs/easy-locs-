...
// ─── Scrape Decision Gate (pre-import validation) ───
export { evaluateScrapeDecision, evaluateBatchScrapeDecisions } from "./scrape-decision-gate";
export type { ScrapeDecision, ScrapeFlag } from "./scrape-decision-gate";
