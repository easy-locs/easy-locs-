...
export const FIELD_PRIORITY: Record<string, Record<string, SourceName[]>> = {
  food: {
  ...
  stay: {
    canonicalName: ["official_web", "booking", "expedia", "govoyage", "airbnb", "google_business"],
  ...
  shops: {
    canonicalName: ["official_web", "amazon", "namshi", "google_business"],
  ...
  mobility: {
    canonicalName: ["official_web", "uber", "bolt", "google_business"],
    description: ["official_web", "google_business"],
    photos: ["official_web", "google_business"],
    rating: ["google_business"],
  },
