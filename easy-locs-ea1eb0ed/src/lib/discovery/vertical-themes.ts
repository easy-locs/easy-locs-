...
export const VERTICAL_THEMES: Record<string, VerticalTheme> = {
  ...
  services: {
    ...
    heroVideo: "https://cdn.pixabay.com/video/2017/08/15/11088-229562171_large.mp4",
  ...
  property: {
    gradient: "linear-gradient(135deg, hsl(226 22% 14%) 0%, hsl(226 22% 22%) 40%, hsl(168 65% 44%) 100%)",
    accentHsl: "38 68% 52%",
    heroImage: heroCover("property"),
    heroVideo: "https://cdn.pixabay.com/video/2020/05/25/40242-423020837_large.mp4",
    heroOverlay: "linear-gradient(135deg, hsl(228 28% 7% / 0.55) 0%, hsl(226 24% 12% / 0.4) 100%)",
  ...
  utility: {
    gradient: "linear-gradient(135deg, hsl(226 24% 25%) 0%, hsl(200 50% 36%) 40%, hsl(180 42% 42%) 100%)",
    accentHsl: "200 50% 36%",
    heroImage: heroCover("utility"),
    heroVideo: "https://cdn.pixabay.com/video/2019/11/05/29078-371457498_large.mp4",
    heroOverlay: "linear-gradient(135deg, hsl(226 24% 10% / 0.55) 0%, hsla(180,42%,20%,0.4) 100%)",
  ...
  stay: {
    gradient: "linear-gradient(135deg, hsl(226 24% 14%) 0%, hsl(215 35% 28%) 40%, hsl(168 60% 42%) 100%)",
    accentHsl: "38 60% 50%",
