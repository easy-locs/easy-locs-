...
export const VERTICAL_THEMES: Record<string, VerticalTheme> = {
  food: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(8,75%,15%,0.4) 0%, hsla(20,85%,25%,0.25) 100%)",
  ...
  grocery: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(145,55%,12%,0.4) 0%, hsla(168,50%,22%,0.25) 100%)",
  ...
  shops: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(275,45%,14%,0.4) 0%, hsla(315,55%,26%,0.25) 100%)",
  ...
  services: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(210,60%,12%,0.4) 0%, hsla(185,50%,24%,0.25) 100%)",
  ...
  property: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(220,42%,8%,0.4) 0%, hsla(220,38%,16%,0.25) 100%)",
  ...
  healthcare: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(195,65%,12%,0.4) 0%, hsla(168,45%,22%,0.25) 100%)",
  ...
  mobility: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(238,42%,12%,0.4) 0%, hsla(278,44%,24%,0.25) 100%)",
  ...
  experiences: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(338,58%,15%,0.4) 0%, hsla(12,68%,24%,0.25) 100%)",
  ...
  utility: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(220,45%,10%,0.4) 0%, hsla(180,42%,20%,0.25) 100%)",
  ...
  stay: {
    ...
    heroOverlay: "linear-gradient(135deg, hsla(220,40%,8%,0.4) 0%, hsla(38,60%,18%,0.25) 100%)",
