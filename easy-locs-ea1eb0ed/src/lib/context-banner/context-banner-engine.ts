...
export function resolveContextBanners(ctx: BannerContext): ContextBanner[] {
  ...
  if (weather.includes("rain") || weather.includes("storm")) {
    banners.push({
      ...
      emoji: "🌧️",
      gradient: "linear-gradient(135deg, hsl(210 50% 25%), hsl(226 24% 28%), hsl(200 55% 40%))",
  ...
  if (weather.includes("heat") || (temp !== null && temp > 38)) {
    banners.push({
      ...
      emoji: "🍦",
      gradient: "linear-gradient(135deg, hsl(195 75% 50%), hsl(210 70% 55%), hsl(220 70% 55%))",
  ...
  if (weather.includes("snow")) {
    banners.push({
      ...
      emoji: "❄️",
      gradient: "linear-gradient(135deg, hsl(200 30% 85%), hsl(210 35% 78%), hsl(226 22% 65%))",
  ...
  if (timePeriod === "afternoon") {
    banners.push({
      ...
      emoji: "🏪",
      gradient: "linear-gradient(135deg, hsl(210 65% 48%), hsl(220 70% 55%), hsl(240 55% 55%))",
