...
import { getLastArchGuardReport, type ArchGuardReport } from "./architecture-guard";
...
export interface RuntimeSnapshot {
  ...
  architectureGuard: ArchGuardReport | null;
}
...
export function getRuntimeSnapshot(): RuntimeSnapshot {
  ...
  return {
    ...
    architectureGuard: getLastArchGuardReport(),
  };
}
