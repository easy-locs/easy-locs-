...
const REGISTERED_CARDS: CardDefinition[] = [
  ...
  { id: "prayer-times", name: "Prayer Times", domain: "prayer", type: "widget", dataSource: "prayer.times", refreshStrategy: "interval", ctaTarget: "/dashboard/islamic" },
  { id: "prayer-next", name: "Next Prayer Countdown", domain: "prayer", type: "stat", dataSource: "prayer.next", refreshStrategy: "interval", ctaTarget: "/dashboard/islamic" },
  { id: "c2c-listings", name: "C2C Active Listings", domain: "c2c", type: "widget", dataSource: "c2c.listings", refreshStrategy: "event", ctaTarget: "/annonces" },
  { id: "c2c-conversations", name: "C2C Conversations", domain: "c2c", type: "stat", dataSource: "c2c.conversations", refreshStrategy: "event", ctaTarget: "/annonces" },
