...
export const routes = {
  ...
  adminDldBackfill: () => `/admin/dld-backfill`,
  customerProfile: () => `/me`,
  ...
  adminFirecrawlUsage: () => `/admin/firecrawl-usage`,
...
export const ROUTE_REGISTRY = [
  ...
  { group: "admin", label: "DLD Backfill", path: "/admin/dld-backfill" },
  ...
  { group: "admin", label: "Firecrawl Usage", path: "/admin/firecrawl-usage" },
