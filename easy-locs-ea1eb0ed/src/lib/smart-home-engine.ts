...
const TIME_PRIORITY: Record<TimeSlot, string[]> = {
  morning:   ["food", "grocery", "pharmacy", "taxi", "services", "beauty", "shops", "stay", "property", "travel", "delivery"],
  lunch:     ["food", "delivery", "shops", "services", "grocery", "taxi", "stay", "property", "travel", "pharmacy", "beauty"],
  afternoon: ["shops", "services", "grocery", "beauty", "delivery", "stay", "property", "travel", "food", "pharmacy", "taxi"],
  dinner:    ["food", "grocery", "delivery", "taxi", "stay", "shops", "services", "property", "travel", "beauty", "pharmacy"],
  latenight: ["food", "delivery", "taxi", "pharmacy", "shops", "stay", "property", "travel", "services", "grocery", "beauty"],
};
...
export function getSmartCategories(timezone?: string, countryCode?: string): SmartCategory[] {
  ...
  return ordered
    .filter(key => !SUPER_SERVICE_KEYS.has(key))
