...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    let mounted = true;
    let latestSeq = 0;
    // Safety timeout: fail-open after a short window so routes are never
    // blocked indefinitely. Cached auth gets slightly more time (2s) to
    // attempt session restoration; cold-start exits faster (1s).
