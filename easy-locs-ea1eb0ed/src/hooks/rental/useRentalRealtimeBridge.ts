      ...
      await invokeSendEmail({
        ...
        html: `<div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff;">
          ...
          <div style="text-align:center;margin:24px 0;">
            <a href="${appUrl}/orbit" style="display:inline-block;background:#d4a853;color:#1a1a1a;font-weight:600;text-decoration:none;padding:12px 32px;border-radius:8px;font-size:15px;">${escapeEmailHtml(replyLabel ?? "Reply")}</a>
          </div>
