/**
 * Contacts mutation helper (edge-function side) — task #928 (L7 P4).
 * Mirror of `content-mutation.ts` for the contacts domain.
 */
...
export interface CtFromEdgeOpts {
  schema?: string;
  source?: string;
...
export function ctRpcEdge<T = unknown>(
  sb: SupabaseClient,
  name: string,
  args?: AnyRecord,
  opts: CtFromEdgeOpts = {},
