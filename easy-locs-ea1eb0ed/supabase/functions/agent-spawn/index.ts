...
// `agent-spawn` is THE single spawn primitive — that work is open and tracked
// separately.
//
...
Deno.serve((req: Request) => {
  ...
  if (pre) return pre;
  return new Response(
    JSON.stringify({ error: "not_implemented", function: "agent-spawn" }),
