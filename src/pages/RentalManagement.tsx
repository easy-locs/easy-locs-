...
type Tab = "dashboard" | "properties" | "tenants" | "documents" | "payments";
          ...
          {tenantTab === "documents" && (
            <div className="bg-card rounded-xl p-6 shadow-card border border-border/50">
              ...
              <div className="space-y-3">
                {["Attestation d'assurance habitation", "Pièce d'identité", "Justificatif de revenus (3 derniers mois)", "RIB", "Caution solidaire", "Contrat de travail / attestation employeur", "Avis d'imposition"].map((doc) => (
