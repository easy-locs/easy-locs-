/**
 * WalletHub — Premium financial cockpit
 */
...
import {
  ...
  Building2, Link2, ExternalLink, Fingerprint,
} from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          {view !== "home" ? (
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-3 px-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-xs text-accent font-semibold hover:text-accent/80 transition-colors"
                  >
              ...
              {/* Bank Connection */}
              <div>
                <h3 className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground mb-3 px-1">
                  ...
                  <div className="p-4 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[10px] text-muted-foreground">
                        {t("orbit.connect_bank_desc") || "Link your bank for instant transfers"}
                      </p>
                    </div>
                  </div>
                  <div className="px-4 pb-4 space-y-2.5">
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-muted/40">
                      ...
                      <span className="text-[10px] text-muted-foreground flex-1">
                        {t("orbit.bank_routed") || "Secure, encrypted connection"}
                      </span>
              ...
              {/* Security Footer */}
              <div className="flex items-center justify-center gap-3 text-[9px] text-muted-foreground/60 py-2">
