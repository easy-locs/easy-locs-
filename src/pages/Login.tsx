        ...
        {mode === "otp" && !otpSent && (
          <form onSubmit={handleSendOtp} className="space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              Un code à 6 chiffres sera envoyé à votre adresse email. Aucun mot de passe requis.
            </p>
            <button
              type="submit" disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-gradient-gold text-accent-foreground font-semibold py-3 rounded-lg shadow-gold hover:opacity-90 transition-opacity disabled:opacity-50"
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-background border border-border rounded-lg px-4 py-3 text-center text-2xl tracking-[0.5em] font-mono focus:outline-none focus:ring-2 focus:ring-ring"
                placeholder="000000"
                autoFocus
              />
            </div>
