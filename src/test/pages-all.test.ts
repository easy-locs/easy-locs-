...
describe("All Tenant Pages — Default Export Check", () => {
  const tenantPages = [
    "TenantDashboard", "TenantReceipts", "TenantDocuments",
    "TenantMessages", "TenantPay", "TenantSettings",
    "TenantRequests", "TenantReviews",
  ];

  tenantPages.forEach((page) => {
    it(`tenant page ${page} can be imported`, async () => {
