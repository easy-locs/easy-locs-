/**
 * useSeasonalBookingActions — Booking request approve/reject/cancel/payment mutations.
...
export function useSeasonalBookingActions({ properties, reload }: UseSeasonalBookingActionsOptions) {
  ...
  return { approveRequest, rejectRequest, cancelRequest, deleteRequest, sendPaymentLink, payingRequest };
}
