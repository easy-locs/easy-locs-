...
export const generateSubSitemapXml = (type: "core" | "countries" | "cities" | "services" | "activities" | "marketplace"): string => {
...
export const generateSitemapIndex = (): string => {
  const sitemaps = ["core", "countries", "cities", "services", "activities", "marketplace"];
