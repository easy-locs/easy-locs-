...
export const CATEGORY_TREE: PrimaryCategory[] = [
  ...
  // ─── 9. PROPERTY ──────────────────────────────────────────
  {
    ...
    subcategories: [
      { value: "apartment", label: "Apartment", emoji: "🏢", cluster: "residential" },
      { value: "villa", label: "Villa", emoji: "🏡", cluster: "residential" },
      { value: "office", label: "Office", emoji: "🏢", cluster: "commercial" },
      { value: "warehouse", label: "Warehouse", emoji: "🏭", cluster: "commercial" },
      { value: "short_stay", label: "Short Stay", emoji: "🛏️", cluster: "residential" },
      { value: "commercial_space", label: "Commercial Space", emoji: "🏬", cluster: "commercial" },
    ],
  },
