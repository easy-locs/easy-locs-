...
export const pageEsExtra: Record<string, string> = {
  ...
  "page.listing_mgr.active": "Activo", "page.listing_mgr.draft": "Borrador", "page.listing_mgr.night": "noche",
  "page.seasonal.showcase": "Propiedades", "page.seasonal.bookings_view": "Reservas",
  "page.seasonal.next_booking": "Próxima reserva", "page.seasonal.no_upcoming": "Sin reservas próximas",
  "page.seasonal.edit": "Editar", "page.seasonal.bookings_btn": "Reservas",
  "page.seasonal.view_page": "Ver anuncio", "page.seasonal.no_listings": "Sin anuncios temporales",
  "page.seasonal.no_listings_hint": "Cree su primer anuncio desde la pestaña estacional de una propiedad.",
...
export const pageDeExtra: Record<string, string> = {
  ...
  "page.listing_mgr.active": "Aktiv", "page.listing_mgr.draft": "Entwurf", "page.listing_mgr.night": "Nacht",
  "page.seasonal.showcase": "Unterkünfte", "page.seasonal.bookings_view": "Buchungen",
  "page.seasonal.next_booking": "Nächste Buchung", "page.seasonal.no_upcoming": "Keine anstehenden Buchungen",
  "page.seasonal.edit": "Bearbeiten", "page.seasonal.bookings_btn": "Buchungen",
  "page.seasonal.view_page": "Öffentliche Seite", "page.seasonal.no_listings": "Noch keine Inserate",
  "page.seasonal.no_listings_hint": "Erstellen Sie Ihr erstes Inserat im Reiter Ferienvermietung.",
...
export const pagePtExtra: Record<string, string> = {
  ...
  "page.listing_mgr.active": "Ativo", "page.listing_mgr.draft": "Rascunho", "page.listing_mgr.night": "noite",
  "page.seasonal.showcase": "Propriedades", "page.seasonal.bookings_view": "Reservas",
  "page.seasonal.next_booking": "Próxima reserva", "page.seasonal.no_upcoming": "Sem reservas próximas",
  "page.seasonal.edit": "Editar", "page.seasonal.bookings_btn": "Reservas",
  "page.seasonal.view_page": "Ver anúncio", "page.seasonal.no_listings": "Sem anúncios temporários",
  "page.seasonal.no_listings_hint": "Crie seu primeiro anúncio na aba sazonal de uma propriedade.",
