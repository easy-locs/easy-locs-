...
const BASE_REGISTRY: CountryEntry[] = [
  ...
  { code: "IE", name: "Ireland", flag: "🇮🇪", defaultLanguage: "en", supportedLanguages: ["en"], currency: "EUR", currencySymbol: "€", locale: "en-IE", dateFormat: "dd/MM/yyyy", timezone: "Europe/Dublin", addressFormat: "anglo", phonePrefix: "+353", phoneFormat: "085 123 4567", measurementUnit: "metric", region: "europe", taxIdLabel: "PPS Number", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "NG", name: "Nigeria", flag: "🇳🇬", defaultLanguage: "en", supportedLanguages: ["en"], currency: "NGN", currencySymbol: "₦", locale: "en-NG", dateFormat: "dd/MM/yyyy", timezone: "Africa/Lagos", addressFormat: "anglo", phonePrefix: "+234", phoneFormat: "0801 234 5678", measurementUnit: "metric", region: "africa", taxIdLabel: "TIN / NIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "KE", name: "Kenya", flag: "🇰🇪", defaultLanguage: "en", supportedLanguages: ["en"], currency: "KES", currencySymbol: "KSh", locale: "en-KE", dateFormat: "dd/MM/yyyy", timezone: "Africa/Nairobi", addressFormat: "anglo", phonePrefix: "+254", phoneFormat: "0712 345678", measurementUnit: "metric", region: "africa", taxIdLabel: "KRA PIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "GH", name: "Ghana", flag: "🇬🇭", defaultLanguage: "en", supportedLanguages: ["en"], currency: "GHS", currencySymbol: "GH₵", locale: "en-GH", dateFormat: "dd/MM/yyyy", timezone: "Africa/Accra", addressFormat: "anglo", phonePrefix: "+233", phoneFormat: "024 123 4567", measurementUnit: "metric", region: "africa", taxIdLabel: "TIN / Ghana Card", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "ZA", name: "South Africa", flag: "🇿🇦", defaultLanguage: "en", supportedLanguages: ["en"], currency: "ZAR", currencySymbol: "R", locale: "en-ZA", dateFormat: "yyyy/MM/dd", timezone: "Africa/Johannesburg", addressFormat: "anglo", phonePrefix: "+27", phoneFormat: "071 234 5678", measurementUnit: "metric", region: "africa", taxIdLabel: "ID / Tax Ref", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "IN", name: "India", flag: "🇮🇳", defaultLanguage: "en", supportedLanguages: ["en"], currency: "INR", currencySymbol: "₹", locale: "en-IN", dateFormat: "dd/MM/yyyy", timezone: "Asia/Kolkata", addressFormat: "anglo", phonePrefix: "+91", phoneFormat: "98765 43210", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "PAN / Aadhaar", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "SG", name: "Singapore", flag: "🇸🇬", defaultLanguage: "en", supportedLanguages: ["en"], currency: "SGD", currencySymbol: "S$", locale: "en-SG", dateFormat: "dd/MM/yyyy", timezone: "Asia/Singapore", addressFormat: "anglo", phonePrefix: "+65", phoneFormat: "8123 4567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "NRIC / FIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "MY", name: "Malaysia", flag: "🇲🇾", defaultLanguage: "en", supportedLanguages: ["en"], currency: "MYR", currencySymbol: "RM", locale: "en-MY", dateFormat: "dd/MM/yyyy", timezone: "Asia/Kuala_Lumpur", addressFormat: "anglo", phonePrefix: "+60", phoneFormat: "012-345 6789", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "IC / SST ID", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "PH", name: "Philippines", flag: "🇵🇭", defaultLanguage: "en", supportedLanguages: ["en"], currency: "PHP", currencySymbol: "₱", locale: "en-PH", dateFormat: "MM/dd/yyyy", timezone: "Asia/Manila", addressFormat: "anglo", phonePrefix: "+63", phoneFormat: "0917 123 4567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "TIN / PhilSys ID", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "NZ", name: "New Zealand", flag: "🇳🇿", defaultLanguage: "en", supportedLanguages: ["en"], currency: "NZD", currencySymbol: "NZ$", locale: "en-NZ", dateFormat: "dd/MM/yyyy", timezone: "Pacific/Auckland", addressFormat: "anglo", phonePrefix: "+64", phoneFormat: "021 123 4567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "IRD number", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "PK", name: "Pakistan", flag: "🇵🇰", defaultLanguage: "en", supportedLanguages: ["en"], currency: "PKR", currencySymbol: "₨", locale: "en-PK", dateFormat: "dd/MM/yyyy", timezone: "Asia/Karachi", addressFormat: "anglo", phonePrefix: "+92", phoneFormat: "0300 1234567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "CNIC / NTN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "BD", name: "Bangladesh", flag: "🇧🇩", defaultLanguage: "en", supportedLanguages: ["en"], currency: "BDT", currencySymbol: "৳", locale: "en-BD", dateFormat: "dd/MM/yyyy", timezone: "Asia/Dhaka", addressFormat: "anglo", phonePrefix: "+880", phoneFormat: "01712-345678", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "NID / TIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "LK", name: "Sri Lanka", flag: "🇱🇰", defaultLanguage: "en", supportedLanguages: ["en"], currency: "LKR", currencySymbol: "Rs", locale: "en-LK", dateFormat: "dd/MM/yyyy", timezone: "Asia/Colombo", addressFormat: "anglo", phonePrefix: "+94", phoneFormat: "071 234 5678", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "NIC / TIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "NP", name: "Nepal", flag: "🇳🇵", defaultLanguage: "en", supportedLanguages: ["en"], currency: "NPR", currencySymbol: "₨", locale: "en-NP", dateFormat: "dd/MM/yyyy", timezone: "Asia/Kathmandu", addressFormat: "anglo", phonePrefix: "+977", phoneFormat: "984-1234567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "PAN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "KH", name: "Cambodia", flag: "🇰🇭", defaultLanguage: "en", supportedLanguages: ["en"], currency: "KHR", currencySymbol: "៛", locale: "en-KH", dateFormat: "dd/MM/yyyy", timezone: "Asia/Phnom_Penh", addressFormat: "asian", phonePrefix: "+855", phoneFormat: "012 345 678", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "National ID", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "MM", name: "Myanmar", flag: "🇲🇲", defaultLanguage: "en", supportedLanguages: ["en"], currency: "MMK", currencySymbol: "K", locale: "en-MM", dateFormat: "dd/MM/yyyy", timezone: "Asia/Yangon", addressFormat: "asian", phonePrefix: "+95", phoneFormat: "09 123456789", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "NRC", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "HK", name: "Hong Kong", flag: "🇭🇰", defaultLanguage: "en", supportedLanguages: ["en"], currency: "HKD", currencySymbol: "HK$", locale: "en-HK", dateFormat: "dd/MM/yyyy", timezone: "Asia/Hong_Kong", addressFormat: "anglo", phonePrefix: "+852", phoneFormat: "9123 4567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "HKID", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "KZ", name: "Kazakhstan", flag: "🇰🇿", defaultLanguage: "en", supportedLanguages: ["en"], currency: "KZT", currencySymbol: "₸", locale: "en-KZ", dateFormat: "dd.MM.yyyy", timezone: "Asia/Almaty", addressFormat: "european", phonePrefix: "+7", phoneFormat: "701 123 4567", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "ИИН / БИН", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "JM", name: "Jamaica", flag: "🇯🇲", defaultLanguage: "en", supportedLanguages: ["en"], currency: "JMD", currencySymbol: "J$", locale: "en-JM", dateFormat: "dd/MM/yyyy", timezone: "America/Jamaica", addressFormat: "anglo", phonePrefix: "+1", phoneFormat: "(876) 123-4567", measurementUnit: "metric", region: "americas", taxIdLabel: "TRN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "TT", name: "Trinidad & Tobago", flag: "🇹🇹", defaultLanguage: "en", supportedLanguages: ["en"], currency: "TTD", currencySymbol: "TT$", locale: "en-TT", dateFormat: "dd/MM/yyyy", timezone: "America/Port_of_Spain", addressFormat: "anglo", phonePrefix: "+1", phoneFormat: "(868) 123-4567", measurementUnit: "metric", region: "americas", taxIdLabel: "NIS / BIR", legalDocumentTypes: ["lease-residential", "rent-receipt"] },

  // ─── EXTRA AFRICA ───
  { code: "EG", name: "Egypt", flag: "🇪🇬", defaultLanguage: "en", supportedLanguages: ["en", "ar"], currency: "EGP", currencySymbol: "E£", locale: "en-EG", dateFormat: "dd/MM/yyyy", timezone: "Africa/Cairo", addressFormat: "arabic", phonePrefix: "+20", phoneFormat: "010 1234 5678", measurementUnit: "metric", region: "africa", taxIdLabel: "National ID / TIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "ET", name: "Ethiopia", flag: "🇪🇹", defaultLanguage: "en", supportedLanguages: ["en"], currency: "ETB", currencySymbol: "Br", locale: "en-ET", dateFormat: "dd/MM/yyyy", timezone: "Africa/Addis_Ababa", addressFormat: "anglo", phonePrefix: "+251", phoneFormat: "091 123 4567", measurementUnit: "metric", region: "africa", taxIdLabel: "TIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "TZ", name: "Tanzania", flag: "🇹🇿", defaultLanguage: "en", supportedLanguages: ["en"], currency: "TZS", currencySymbol: "TSh", locale: "en-TZ", dateFormat: "dd/MM/yyyy", timezone: "Africa/Dar_es_Salaam", addressFormat: "anglo", phonePrefix: "+255", phoneFormat: "0712 345 678", measurementUnit: "metric", region: "africa", taxIdLabel: "TIN / NIDA", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "UG", name: "Uganda", flag: "🇺🇬", defaultLanguage: "en", supportedLanguages: ["en"], currency: "UGX", currencySymbol: "USh", locale: "en-UG", dateFormat: "dd/MM/yyyy", timezone: "Africa/Kampala", addressFormat: "anglo", phonePrefix: "+256", phoneFormat: "077 123 4567", measurementUnit: "metric", region: "africa", taxIdLabel: "TIN / NIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "RS", name: "Serbia", flag: "🇷🇸", defaultLanguage: "en", supportedLanguages: ["en"], currency: "RSD", currencySymbol: "din.", locale: "sr-RS", dateFormat: "dd.MM.yyyy", timezone: "Europe/Belgrade", addressFormat: "european", phonePrefix: "+381", phoneFormat: "069 123 4567", measurementUnit: "metric", region: "europe", taxIdLabel: "JMBG / PIB", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "GE", name: "Georgia", flag: "🇬🇪", defaultLanguage: "en", supportedLanguages: ["en"], currency: "GEL", currencySymbol: "₾", locale: "ka-GE", dateFormat: "dd.MM.yyyy", timezone: "Asia/Tbilisi", addressFormat: "european", phonePrefix: "+995", phoneFormat: "555 12 34 56", measurementUnit: "metric", region: "europe", taxIdLabel: "Personal No.", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "IS", name: "Iceland", flag: "🇮🇸", defaultLanguage: "en", supportedLanguages: ["en"], currency: "ISK", currencySymbol: "kr", locale: "is-IS", dateFormat: "dd.MM.yyyy", timezone: "Atlantic/Reykjavik", addressFormat: "european", phonePrefix: "+354", phoneFormat: "612 3456", measurementUnit: "metric", region: "europe", taxIdLabel: "Kennitala", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "MT", name: "Malta", flag: "🇲🇹", defaultLanguage: "en", supportedLanguages: ["en"], currency: "EUR", currencySymbol: "€", locale: "en-MT", dateFormat: "dd/MM/yyyy", timezone: "Europe/Malta", addressFormat: "european", phonePrefix: "+356", phoneFormat: "7912 3456", measurementUnit: "metric", region: "europe", taxIdLabel: "ID Card / VAT", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "BA", name: "Bosnia & Herzegovina", flag: "🇧🇦", defaultLanguage: "en", supportedLanguages: ["en"], currency: "BAM", currencySymbol: "KM", locale: "bs-BA", dateFormat: "dd.MM.yyyy", timezone: "Europe/Sarajevo", addressFormat: "european", phonePrefix: "+387", phoneFormat: "061 123 456", measurementUnit: "metric", region: "europe", taxIdLabel: "JMBG / JIB", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "ME", name: "Montenegro", flag: "🇲🇪", defaultLanguage: "en", supportedLanguages: ["en"], currency: "EUR", currencySymbol: "€", locale: "sr-ME", dateFormat: "dd.MM.yyyy", timezone: "Europe/Podgorica", addressFormat: "european", phonePrefix: "+382", phoneFormat: "067 123 456", measurementUnit: "metric", region: "europe", taxIdLabel: "JMBG / PIB", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "XK", name: "Kosovo", flag: "🇽🇰", defaultLanguage: "en", supportedLanguages: ["en"], currency: "EUR", currencySymbol: "€", locale: "sq-XK", dateFormat: "dd.MM.yyyy", timezone: "Europe/Belgrade", addressFormat: "european", phonePrefix: "+383", phoneFormat: "044 123 456", measurementUnit: "metric", region: "europe", taxIdLabel: "NUI / NF", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  { code: "MD", name: "Moldova", flag: "🇲🇩", defaultLanguage: "en", supportedLanguages: ["en", "ro"], currency: "MDL", currencySymbol: "lei", locale: "ro-MD", dateFormat: "dd.MM.yyyy", timezone: "Europe/Chisinau", addressFormat: "european", phonePrefix: "+373", phoneFormat: "069 123 456", measurementUnit: "metric", region: "europe", taxIdLabel: "IDNP / IDNO", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
  ...
  { code: "LA", name: "Laos", flag: "🇱🇦", defaultLanguage: "en", supportedLanguages: ["en"], currency: "LAK", currencySymbol: "₭", locale: "lo-LA", dateFormat: "dd/MM/yyyy", timezone: "Asia/Vientiane", addressFormat: "asian", phonePrefix: "+856", phoneFormat: "020 1234 5678", measurementUnit: "metric", region: "asia_pacific", taxIdLabel: "TIN", legalDocumentTypes: ["lease-residential", "rent-receipt"] },
