...
export const ENGINE_METADATA: Record<string, EngineMetadata> = {
  ...
  "seo-check":             { tier: "standard",    businessFn: "visibility",     vertical: "all",     canRunIdle: false, tablesWritten: ["seed_merchants"],   fieldsWritten: ["seo_score"],                                         description: "SEO optimization check",                                brainOwner: "experience" },
  ...
  "inventory-check":       { tier: "priority",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["seed_merchants"],   fieldsWritten: ["visibility_mode"],                                   description: "Checks inventory availability",                         brainOwner: "execution" },
  ...
  "abandoned-cart":        { tier: "priority",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["abandoned_cart_events"], fieldsWritten: ["status"],                                      description: "Recovers abandoned carts",                              brainOwner: "experience" },
  ...
  "entity-integrity":      { tier: "critical",    businessFn: "onboarding",     vertical: "all",     canRunIdle: false, tablesWritten: ["seed_merchants"],    fieldsWritten: ["visibility_mode", "visibility_decision_reason"],    description: "Validates entity fields, state, and journey",           brainOwner: "category" },
  ...
  "travel-transition":     { tier: "standard",    businessFn: "conversion",     vertical: "all",     canRunIdle: true,  tablesWritten: [],                    fieldsWritten: [],                                                   description: "Detects travel context and provides smart guidance",     brainOwner: "experience" },
