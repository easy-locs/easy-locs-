...
export const ENGINE_METADATA: Record<string, EngineMetadata> = {
  ...
  "platform-orchestrator": { tier: "critical",    businessFn: "infrastructure", vertical: "all", canRunIdle: true,  tablesWritten: ["platform_actions_log", "platform_health_scores"], fieldsWritten: ["action_type", "severity", "global_score"], description: "Autonomous governance brain — decides, acts, logs" },
  ...
  // ── AI PERSONAL RADAR (Engines #97-108) ──
  "personal-profile":      { tier: "priority",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["user_radar_profiles"],     fieldsWritten: ["taste_scores_json", "lifestyle_tags"],              description: "Builds & refreshes personal radar profiles from behavior" },
  "preference-learning":   { tier: "priority",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["user_radar_profiles"],     fieldsWritten: ["preferred_categories", "preferred_verticals"],      description: "Learns user preferences from clicks, views, orders" },
  "context-awareness":     { tier: "critical",    businessFn: "conversion",     vertical: "all",     canRunIdle: true,  tablesWritten: [],                          fieldsWritten: [],                                                   description: "Understands current user context: time, zone, travel state" },
  "next-best-action":      { tier: "critical",    businessFn: "conversion",     vertical: "all",     canRunIdle: true,  tablesWritten: [],                          fieldsWritten: [],                                                   description: "Decides what radar should propose right now" },
  "personal-ranking":      { tier: "critical",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["user_radar_recommendations"], fieldsWritten: ["personal_score"],                               description: "Ranks entities per-user with affinity, context, budget" },
  "personal-offer":        { tier: "standard",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["user_radar_recommendations"], fieldsWritten: ["recommendation_type"],                          description: "Pushes targeted offers based on profile + context" },
  "travel-mode":           { tier: "standard",    businessFn: "conversion",     vertical: "all",     canRunIdle: true,  tablesWritten: [],                          fieldsWritten: [],                                                   description: "Detects travel mode: tourist, business, local, nomad" },
  "budget-fit":            { tier: "standard",    businessFn: "conversion",     vertical: "all",     canRunIdle: true,  tablesWritten: [],                          fieldsWritten: [],                                                   description: "Adapts results to user spending profile" },
  "taste-affinity":        { tier: "priority",    businessFn: "conversion",     vertical: "all",     canRunIdle: false, tablesWritten: ["user_radar_profiles"],     fieldsWritten: ["taste_scores_json"],                                description: "Computes taste affinity scores per category" },
