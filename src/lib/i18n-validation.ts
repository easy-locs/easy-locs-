...
export const notifKeys: Record<string, Record<string, string>> = {
  fr: {
    ...
    "notif.test_sent": "Notification test envoyée !",
  ...
  en: {
    ...
    "notif.test_sent": "Test notification sent!",
  ...
  es: {
    ...
    "notif.browser_notifications": "Notificaciones del navegador", "notif.sound": "Sonido de notificación", "notif.vibration": "Vibración",
    "notif.per_type_alerts": "Alertas por tipo", "notif.send_test": "Enviar notificación de prueba", "notif.test_sent": "¡Notificación de prueba enviada!",
    "notif.channel_prefs": "Canales de notificación", "notif.urgent_only": "Solo urgente",
    "notif.status_summary": "Resumen de estado", "notif.status_on": "Activado", "notif.status_off": "Desactivado",
    "notif.enable": "Activar", "notif.types_enabled": "tipos activados de",
  },
  de: {
    ...
    "notif.browser_notifications": "Browser-Benachrichtigungen", "notif.sound": "Benachrichtigungston", "notif.vibration": "Vibration",
    "notif.per_type_alerts": "Alarme nach Typ", "notif.send_test": "Testbenachrichtigung senden", "notif.test_sent": "Testbenachrichtigung gesendet!",
    "notif.channel_prefs": "Benachrichtigungskanäle", "notif.urgent_only": "Nur dringende",
    "notif.status_summary": "Statusübersicht", "notif.status_on": "Ein", "notif.status_off": "Aus",
    "notif.enable": "Aktivieren", "notif.types_enabled": "Typen aktiviert von",
  },
  it: {
    ...
    "notif.alert_settings": "Impostazioni avvisi", "notif.sound": "Suono notifica", "notif.vibration": "Vibrazione",
    "notif.per_type_alerts": "Avvisi per tipo", "notif.send_test": "Invia notifica di test", "notif.test_sent": "Notifica di test inviata!",
    "notif.channel_prefs": "Canali di notifica", "notif.urgent_only": "Solo urgenti",
    "notif.status_summary": "Riepilogo stato", "notif.status_on": "Attivo", "notif.status_off": "Disattivato",
    "notif.enable": "Attiva", "notif.types_enabled": "tipi attivati su",
  },
  pt: {
    ...
    "notif.alert_settings": "Configurações de alerta", "notif.sound": "Som de notificação", "notif.vibration": "Vibração",
    "notif.per_type_alerts": "Alertas por tipo", "notif.send_test": "Enviar notificação de teste", "notif.test_sent": "Notificação de teste enviada!",
    "notif.channel_prefs": "Canais de notificação", "notif.urgent_only": "Apenas urgentes",
    "notif.status_summary": "Resumo do status", "notif.status_on": "Ativado", "notif.status_off": "Desativado",
    "notif.enable": "Ativar", "notif.types_enabled": "tipos ativados de",
  },
  nl: {
