  ...
  const navSections: NavSection[] = [
    ...
    // 5. Marketplace — services & concierge
    {
      ...
      items: [
        ...
        { icon: Zap, label: t("nav.concierge") || "Concierge", path: "/dashboard/concierge" },
      ],
    },
  ...
  return (
    <div className="min-h-screen flex bg-background mobile-safe">
      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0">
        <header className="h-14 border-b border-border bg-card/95 backdrop-blur-sm flex items-center px-2 sm:px-6 gap-1.5 sm:gap-3 sticky top-0 z-30">
