...
export default function UpdateNotification() {
  ...
  return (
    <>
      <div className="fixed bottom-2 left-2 z-[9998] rounded-lg border border-border bg-card/95 px-2 py-1 text-[10px] font-medium text-muted-foreground shadow-sm backdrop-blur-sm">
        Build {APP_VERSION}
      </div>
      <AnimatePresence>
        {visible && (
