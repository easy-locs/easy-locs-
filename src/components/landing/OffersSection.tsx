...
import { ArrowRight, Gift, Sparkles, Zap, Calendar } from "lucide-react";

const OFFERS = [
  {
    title: "Summer Sale — Up to 40% Off",
    sub: "Hotels & stays worldwide",
  ...
  {
    title: "New Pro? Get 3 Months Free",
    sub: "Launch your business on Easy-Locs",
...
export default function OffersSection() {
  return (
    <section className="py-10 sm:py-14 bg-background" aria-label="Offers & Events">
        ...
        <div className="flex gap-4 overflow-x-auto pb-3 scrollbar-none snap-x snap-mandatory sm:grid sm:grid-cols-3 sm:overflow-visible sm:pb-0">
          {OFFERS.map((offer, i) => (
            ...
            >
              <Link
                to={offer.to}
                className="group block rounded-2xl p-5 sm:p-6 relative overflow-hidden hover:shadow-xl transition-all duration-300"
