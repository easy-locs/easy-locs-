  ...
  return (
    <section id="pricing" className="py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="container max-w-lg relative z-10">
        ...
        >
          {interval === "annual" && (
            <div className="absolute -top-0.5 left-1/2 -translate-x-1/2 bg-gradient-gold text-accent-foreground text-xs font-bold px-4 py-1 rounded-b-lg flex items-center gap-1">
          ...
          <Link
            to="/onboarding"
            className="block w-full text-center py-3 rounded-xl font-bold text-sm transition-all relative overflow-hidden group"
