                  ...
                  {mockActivities.map((a, i) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs leading-snug truncate" style={{ color: "hsl(var(--primary-foreground) / 0.75)" }}>{a.text}</p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                {SERVICE_CATEGORIES.map((cat, i) => (
                  ...
                  >
                    ...
                    <p className="text-[11px] font-bold text-center truncate" style={{ color: "hsl(var(--primary-foreground) / 0.85)" }}>{cat.label}</p>
                    <p className="text-[9px] text-center mt-0.5" style={{ color: `hsl(var(--${cat.color}))` }}>{cat.price}</p>
                    <div className="flex items-center justify-center gap-1 mt-1.5">
                      <Star className="h-2.5 w-2.5" style={{ color: "hsl(var(--accent))" }} />
                      <span className="text-[9px] font-semibold" style={{ color: "hsl(var(--primary-foreground) / 0.4)" }}>{cat.bookings} booked</span>
                    </div>
                  </motion.div>
                ))}
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-5">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {PAYMENT_METHODS.map((pm, i) => (
                    ...
                    >
                      ...
                      <span className="text-[9px] font-bold" style={{ color: "hsl(var(--primary-foreground) / 0.6)" }}>{pm.label}</span>
                    </motion.div>
                  ))}
                </div>
                <div className="flex items-center gap-2 mt-3 px-1">
                  <CheckCircle2 className="h-3 w-3 shrink-0" style={{ color: "hsl(var(--success))" }} />
                  <span className="text-[10px]" style={{ color: "hsl(var(--primary-foreground) / 0.4)" }}>Direct payments — No platform commission</span>
                </div>
              </div>
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-2">
                  {SHARE_PLATFORMS.map((sp, i) => (
                    ...
                    >
                      ...
                      <span className="text-[9px] font-bold" style={{ color: "hsl(var(--primary-foreground) / 0.5)" }}>{sp.label}</span>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="flex items-center gap-2 mt-3 px-1">
                  ...
                  <span className="text-[10px]" style={{ color: "hsl(var(--primary-foreground) / 0.4)" }}>Product photo in link preview — Stable links</span>
                </div>
              </div>
            </div>
