      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="floating-ai-btn fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-gradient-to-br from-accent to-accent/80 text-accent-foreground shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center group"
