      ...
      <AnimatePresence>
        {!open && (
          <motion.button
            ...
            className="floating-ai-btn fixed bottom-20 lg:bottom-6 right-4 z-30 w-12 h-12 rounded-full bg-gradient-to-br from-accent to-accent/80 text-accent-foreground shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center group"
