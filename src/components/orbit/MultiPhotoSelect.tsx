      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3"
          ...
          <span className="text-sm font-bold" style={{ color: "hsl(var(--foreground))" }}>
            {items.length > 0 ? getGroupPreviewLabel(meta) : (t("media.select") || "Select media")}
          </span>
          <button
            onClick={handleSend}
          ...
          {items.length === 0 ? (
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: "hsl(var(--muted-foreground))" }}>
                {t("media.tap_to_select") || "Tap to select photos & videos"}
              </span>
            </button>
          ) : (
        ...
        {items.length > 0 && (
          <div className="px-4 py-3" style={{ borderTop: "1px solid hsl(var(--border) / 0.1)" }}>
            <input
              ...
              placeholder={t("media.caption_placeholder") || "Add a caption..."}
