/**
 * app-route-registry — Centralized lazy page imports for App.tsx.
 * Removes ~500 lines of imports from App.tsx.
 */
...
export const RetailMall    = safeLazy(() => import("@/pages/universe/RetailMallPage"), "RetailMallPage");
export const Retail    = safeLazy(() => import("@/pages/universe/RetailStorePage"), "RetailStorePage");
...
export const UrlImportPage = safeLazy(() => import("@/pages/admin/AdminShopImportPage"), "UrlImportPage");
...
export const CustomerSavedCartsPage = safeLazy(() => import("@/pages/customer/CustomerSavedCartsPage"), "CustomerSavedCartsPage");
