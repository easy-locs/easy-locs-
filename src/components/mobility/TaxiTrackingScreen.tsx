    ...
    >
      ...
      <div className="rounded-2xl border border-border/30 bg-card p-4 space-y-3">
        ...
        <div className="flex gap-2">
          <button className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl bg-muted/40 text-xs font-semibold text-foreground">
      ...
      <div className="flex items-center gap-3 rounded-xl bg-muted/20 px-4 py-2.5">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-muted-foreground">Live tracking, verified driver, route monitoring</p>
        </div>
      </div>
