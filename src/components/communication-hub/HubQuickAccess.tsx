  ...
  if (variant === "topbar") {
    return (
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-0.5 -end-0.5 bg-accent text-accent-foreground text-[9px] font-bold rounded-full h-4 min-w-[16px] flex items-center justify-center px-1 shadow-sm">
            {unread > 99 ? "99+" : unread}
          </span>
        )}
      </Link>
