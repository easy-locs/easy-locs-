    ...
    >
      ...
      <div className="px-3 py-2.5 space-y-0.5">
        <div className="flex items-center gap-1.5">
          <Globe className="h-3 w-3 shrink-0" style={{ color: "hsl(var(--hud-text-dim) / 0.5)" }} />
        ...
        {meta.description && (
          <p className="text-[11px] leading-snug line-clamp-2" style={{ color: "hsl(var(--hud-text-dim) / 0.6)" }}>
            {meta.description}
          </p>
        )}
      </div>
